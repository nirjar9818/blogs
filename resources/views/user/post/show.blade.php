            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="main_blog_details">
                        ...
                        <img class="img-fluid" src="{{asset('storage/post/'.$posts->image)}}" alt="">
                            ...
                            <div class="float-right mt-sm-0 mt-3">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <p>{{$posts->created_at->format('Y-M-d')}}</p>
                                    </div>
                                    <div class="d-flex">
                                        <img width="42" height="42" src="{{asset('frontend/img/admin_avatar.jpg')}}"
                                             alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="navigation-area">
                        <div class="row">
                            <div
                                ...
                                @if(isset($previous))
                                    <div class="thumb">
                                        <a href="{{route('post.show',$previous->id) }}"><img class="img-fluid"
                                                                                             src="{{asset('frontend/img/admin_avatar.jpg')}}"
                                                                                             width="100px" alt=""></a>
                                    </div>
                                    <div class="arrow">
