                        ...
                        @endif
                            <form method="post" action="{{ route('category.update', $categories->id ) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="3" columns="3" id="summernote" class="form-control" name="short_description">{{ $categories->short_description }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="long_description">Long Description:</label>
                                    <textarea rows="9" columns="9" id="summernote2" class="form-control" name="long_description">{{ $categories->long_description }}</textarea>
                                </div>
                                <div class="form-group">
